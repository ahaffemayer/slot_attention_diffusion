...
from conditional_diffusion_motion.diffusion_transformer.datasets.indirect_motion_with_obstacles_without_cond_box import IndirectDataModuleWithObstacleWithoutCond
