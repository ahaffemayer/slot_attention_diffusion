...
class IndirectMotionDatasetWithObstaclesWithShelfCspace(Dataset):
    def __init__(self, data_dir: Path, device="cuda"):
        ...
        file_cspaces = (
            cache_dir
            / "indirect_motion_with_obstacles_cache_with_shelf_cspace.npy"
        )
...
class IndirectDataModuleWithObstacleWithShelfCspace(pl.LightningDataModule):
    """Defines the data used for training the diffusion process."""

    def __init__(self, data_dir:Path = None) -> None:
        super().__init__()

        self.dataset = IndirectMotionDatasetWithObstaclesWithShelfCspace(
