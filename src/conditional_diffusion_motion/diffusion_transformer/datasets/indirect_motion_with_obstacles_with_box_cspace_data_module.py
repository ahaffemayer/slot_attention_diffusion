...
class IndirectMotionDatasetWithObstaclesWithBoxCspace(Dataset):
    def __init__(self, data_dir: Path, device="cuda"):
        ...
        self.image_dir = (
            self.data_dir / "generated_scenes" / "box_for_diffusion"
        )
        ...
        file_samples = (
            cache_dir
            / "indirect_motion_with_obstacles_cache_samples_with_box.npy"
        )
        file_q0 = (
            cache_dir
            / "indirect_motion_with_obstacles_cache_q0_with_box.npy"
        )
        file_goal = (
            cache_dir
            / "indirect_motion_with_obstacles_cache_goal_with_box.npy"
        )
        file_scenes = (
            cache_dir
            / "indirect_motion_with_obstacles_cache_scene_ids_with_box.npy"
        )
        file_cspaces = (
            cache_dir
            / "indirect_motion_with_obstacles_cache_with_box_cspace.npy"
        )
...
class IndirectDataModuleWithObstacleWithBoxCspace(pl.LightningDataModule):
    """Defines the data used for training the diffusion process."""

    def __init__(self, data_dir:Path = None) -> None:
        super().__init__()

        self.dataset = IndirectMotionDatasetWithObstaclesWithBoxCspace(
