...
class DiffusionMotion(pl.LightningModule):
    def __init__(self, model=None, noise_scheduler=None, default_diffusion_steps=1000) -> None:
        super().__init__()
        self.model = model
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        pred = self.model(sample=self.generate_x_t(samples, t), noising_time_steps=t, cond=conds)
