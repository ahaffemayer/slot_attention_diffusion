...
from conditional_diffusion_motion.diffusion_transformer.models.conditioning.conditioning_slot_attention import (
    ConditioningEncoderSlotAttention,
)
...
class ModelSlotAttention(DiffusionMotion):
    def __init__(self) -> None:
        ...
        conditioning_encoder = ConditioningEncoderSlotAttention(
            condition_shapes={
                "q0": 7,
                "goal": 3,
                "slots": 64,
