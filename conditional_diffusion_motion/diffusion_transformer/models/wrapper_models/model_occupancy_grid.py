...
from conditional_diffusion_motion.diffusion_transformer.models.conditioning.conditioning_occupancy_grid import (
    ConditioningEncoder3DOccupancyGrid,
)


class ModelOccupancyGrid(DiffusionMotion):
    def __init__(self) -> None:
        """
        Model that uses transformer inside diffusion.
        """
        # Conditioning encoder
        conditioning_encoder = ConditioningEncoder3DOccupancyGrid(
            condition_shapes={
                "q0": 7,
                "goal": 3,
                "occupancy_grid": (16,32,24),
            },
